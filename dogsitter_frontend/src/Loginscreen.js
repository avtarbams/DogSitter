    ...
    constructor(props){
        ...
        loginButtons.push(
            <div>
                <MuiThemeProvider>
                    <div>
                        <RaisedButton label={"Register as Dog Sitter"} primary={true} style={style} onClick={(event) => this.handleClick(event,'dogsitter')}/>
                    </div>
                </MuiThemeProvider>
                <MuiThemeProvider>
                    <div>
                        <RaisedButton label={"Register as Dog Owner"} primary={true} style={style} onClick={(event) => this.handleClick(event,'dogowner')}/>
                    </div>
                </MuiThemeProvider>
            </div>
        )
        this.state={
            ...
            studentbuttonLabel:'Register as Dog Sitter',
            teacherbuttonLabel:'Register as Dog Owner',
            isLogin:true
        }
    }
    componentWillMount(){
